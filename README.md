...
| 当前阶段 | 已有本地可运行 MVP |
| 本次展示基线 | **v0.4.0** |
| 当前状态 | **v0.4.0 已正式发布**（Ruff、完整 pytest 和真人 Smoke Test 已完成） |
| 当前仓库 | 仅用于项目公开展示 |
| 暂未公开 | 完整源码与可安装版本 |
...
- Ruff PASS；
- 完整 pytest 收集 1020 项：1019 passed、1 skipped；唯一跳过项为当前 Windows
  策略不允许测试创建符号链接时的既有条件跳过；
...
- v0.4.0 完整 pytest 收集 1020 项（1019 passed、1 skipped），Ruff 与真人 Smoke Test 通过；
